...
from .paths_config import WINDOW_RESOURCE_PATH, USER_DATA_DIR
from .ui_config import APP_NAME, MENU_TOOLTIP_TEXT, MENU_ITEMS
...
from .messages import RADAR, LOGBOOK, UPDATE
